...
INSERT INTO pni_reports (
    id, patient_id, report_date, hours_asleep, avg_hr, min_hr, deep_sleep, continuity
) VALUES
  (1, 1, '2026-01-09',  7.5,  58.0, 48, 85,  3.8),
  (2, 1, '2026-01-16',  8.0,  55.0, 45, 100, 4.5),
  (3, 2, '2026-01-11',  6.0,  65.0, 55, 60,  2.7),
  (4, 3, '2026-02-04',  7.0,  60.0, 50, 75,  3.5),
  (5, 4, '2026-02-17',  5.5,  70.0, 62, 40,  2.2),
  (6, 5, '2026-03-01',  8.5,  52.0, 42, 110, 4.8),
  (7, 5, '2026-03-08',  8.0,  54.0, 44, 105, 4.6)
ON CONFLICT (id) DO NOTHING;
